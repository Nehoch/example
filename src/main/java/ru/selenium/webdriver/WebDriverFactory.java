...
public class WebDriverFactory {
	...
	public static WebDriver getInstance(String gridHubUrl, Browser browser,
		...
		if (CHROME.equals(browserName)) {
			...
			// HTMLunit Check
			if (username != null && password != null) {
				webDriver = AuthenticatedHtmlUnitDriver.create(username,
						password);
			} else {
		...
		try {
			webDriver = new Augmenter().augment(new RemoteWebDriver(new URL(gridHubUrl), capability));
